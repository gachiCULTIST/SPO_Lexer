...
public enum TokenType : uint {
  eof, Tok_lparen,Tok_rparen,Tok_multiply,Tok_plus,Tok_comma,Tok_minus,Tok_division,Tok_init,Tok_pow,Tok_id,Tok_number,Tok_def,Tok_uminus,Tok_call
}
public class Lexer {
  ...
  public (TokenType type, dynamic attr) getNextToken() {
    ...
    switch(accSt){
      ...
      case 14:
        ...
        return (TokenType.Tok_number,  text );
      ...
      case 28:
        if (debug) Console.Error.WriteLine($"Lexed token uminus: \"{text}\"");
        return (TokenType.Tok_uminus, text /* мне лень вручную это добавлять в перечисление */);
